...
import com.my.nitt_mess_warden.Adapter.MessFeedbackAdapter;
...
public class FeedbackFragment extends Fragment {
    ...
    MessFeedbackAdapter recyclerAdapter;
    List<Mess> messList;
    ...
    private void getMessData(final String MessId) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NotNull DataSnapshot mess) {
                ...
                recyclerAdapter = new MessFeedbackAdapter(messList, getContext());
