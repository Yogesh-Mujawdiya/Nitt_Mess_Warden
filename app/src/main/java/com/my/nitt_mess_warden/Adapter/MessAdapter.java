...
import com.my.nitt_mess_warden.ui.MessRatingFragment;

import java.util.ArrayList;
import java.util.List;

public class MessAdapter extends RecyclerView.Adapter<MessAdapter.ViewHolder> implements Filterable {

    private static final String TAG = "RecyclerAdapter";
    List<Mess> messList, fullList;
    Context context;

    public MessAdapter(List<Mess> messList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, MessRatingActivity.class);
