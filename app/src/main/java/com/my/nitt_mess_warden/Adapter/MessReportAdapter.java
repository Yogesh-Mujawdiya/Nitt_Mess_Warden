...
import com.my.nitt_mess_warden.MessMenuActivity;
import com.my.nitt_mess_warden.MessReportActivity;
import com.my.nitt_mess_warden.R;
import com.my.nitt_mess_warden.ui.MessReportFragment;

import java.util.ArrayList;
import java.util.List;

public class MessReportAdapter extends RecyclerView.Adapter<MessReportAdapter.ViewHolder> implements Filterable {

    private static final String TAG = "RecyclerAdapter";
    List<Mess> messList, fullList;
    Context context;

    public MessReportAdapter(List<Mess> messList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, MessReportActivity.class);
